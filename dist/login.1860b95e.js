...
var loginInput = document.querySelector("input");
var h1 = document.querySelector("h1");
var h2 = document.querySelector("#clock");
var h3 = document.querySelector("#date");
var h4 = document.querySelector("h4");
var toDo = document.querySelector("#todo");
var bgImg = document.querySelector("#bgImage");
var loginImg = document.querySelector("#loginImage");
...
function printH(savedName) {
  ...
  h1.innerText = "\uC548\uB155\uD558\uC138\uC694. ".concat(savedName, ":)");
...
;
var loginImages = ["0.jpg", "3.jpg", "6.jpg", "14.jpg", "15.jpg", "16.jpg", "17.jpg"];
var randomTwo = Math.floor(Math.random() * loginImages.length);
var chosenLoginImage = loginImages[randomTwo];
loginImg.src = "loginImg/".concat(chosenLoginImage);
