...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/memo.js":[function(require,module,exports) {
var memoAdd = document.querySelector("#memo span");
var memoList = document.querySelector("#memo #memo-list");
var liImage = ["memo1.jpg", "memo3.jpg", "memo4.jpg"];
var randomImg = Math.floor(Math.random() * liImage.length);
var memos = [];
...
function createMemo() {
  ...
  li.style.backgroundImage = "linear-gradient(to bottom, rgba(255,255,255,0.5), rgba(255,255,255,0.3)), url(./img/".concat(liImage[randomImg], ")");
...
if (savedMemos !== null) {
  var parsedMemos = JSON.parse(savedMemos);
  memos = parsedMemos;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/memo.js"], null)
//# sourceMappingURL=/memo.febcd933.js.mapsourceMappingURL=/memo.febcd933.js.map